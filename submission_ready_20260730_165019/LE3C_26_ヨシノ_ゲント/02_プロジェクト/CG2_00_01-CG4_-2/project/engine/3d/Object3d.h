...
public:
	...
	bool TransitionToAnimation(const Animation& animation, float durationSeconds);
	[[nodiscard]] bool IsAnimationTransitionActive() const { return animationTransitionActive_; }
	[[nodiscard]] float GetAnimationTransitionProgress() const;
...
private:
	...
	Animation transitionSourceAnimation_;
	float transitionSourceTime_ = 0.0f;
